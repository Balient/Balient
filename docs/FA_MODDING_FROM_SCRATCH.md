...
یک مرجع decode شده و خام از **Bale 10.15.25 (164148)** نیز در مسیر [`src/bale_164148_apktool/`](../src/bale_164148_apktool/) موجود است. برای مشخصات دقیق آن، [BASE_BALE_164148.md](BASE_BALE_164148.md) را ببینید.
