...
.field private final c:Lio/sentry/n3;

.field private final d:Lio/sentry/transport/A;
...
# direct methods
.method public constructor <init>(Lio/sentry/n3;Lio/sentry/transport/A;Lio/sentry/transport/r;Lio/sentry/y1;)V
    .locals 10

    .line 1
    invoke-virtual {p1}, Lio/sentry/n3;->getMaxQueueSize()I

    move-result v0

    .line 2
    invoke-virtual {p1}, Lio/sentry/n3;->getEnvelopeDiskCache()Lio/sentry/cache/g;
    ...
    .line 5
    invoke-static {v0, v1, v2, v3}, Lio/sentry/transport/e;->n(ILio/sentry/cache/g;Lio/sentry/ILogger;Lio/sentry/i2;)Lio/sentry/transport/w;

    move-result-object v5

    new-instance v9, Lio/sentry/transport/o;

    invoke-direct {v9, p1, p4, p2}, Lio/sentry/transport/o;-><init>(Lio/sentry/n3;Lio/sentry/y1;Lio/sentry/transport/A;)V
    ...
    .line 6
    invoke-direct/range {v4 .. v9}, Lio/sentry/transport/e;-><init>(Lio/sentry/transport/w;Lio/sentry/n3;Lio/sentry/transport/A;Lio/sentry/transport/r;Lio/sentry/transport/o;)V

    return-void
.end method

.method public constructor <init>(Lio/sentry/transport/w;Lio/sentry/n3;Lio/sentry/transport/A;Lio/sentry/transport/r;Lio/sentry/transport/o;)V
    .locals 1
    ...
    .line 10
    invoke-virtual {p2}, Lio/sentry/n3;->getEnvelopeDiskCache()Lio/sentry/cache/g;
    ...
    iput-object p1, p0, Lio/sentry/transport/e;->c:Lio/sentry/n3;
...
.method public static synthetic a(Lio/sentry/hints/p;)V
    ...
    .line 1
    invoke-static {p0}, Lio/sentry/transport/e;->q(Lio/sentry/hints/p;)V
...
.method public static synthetic b(Lio/sentry/transport/e;Lio/sentry/hints/g;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lio/sentry/transport/e;->u(Lio/sentry/hints/g;)V

    return-void
.end method

.method public static synthetic f(ZLio/sentry/hints/k;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lio/sentry/transport/e;->r(ZLio/sentry/hints/k;)V

    return-void
.end method

.method public static synthetic g(Lio/sentry/cache/g;Lio/sentry/ILogger;Ljava/lang/Runnable;Ljava/util/concurrent/ThreadPoolExecutor;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lio/sentry/transport/e;->o(Lio/sentry/cache/g;Lio/sentry/ILogger;Ljava/lang/Runnable;Ljava/util/concurrent/ThreadPoolExecutor;)V

    return-void
.end method

.method static synthetic h(Lio/sentry/transport/e;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
...
.method static synthetic i(Lio/sentry/transport/e;)Lio/sentry/n3;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/sentry/transport/e;->c:Lio/sentry/n3;
...
.method static synthetic j(Lio/sentry/transport/e;)Lio/sentry/transport/r;
    .locals 0
...
.method static synthetic l(Lio/sentry/transport/e;)Lio/sentry/transport/o;
    .locals 0
...
.method private static n(ILio/sentry/cache/g;Lio/sentry/ILogger;Lio/sentry/i2;)Lio/sentry/transport/w;
    .locals 7
    ...
    .line 19
    invoke-direct/range {v0 .. v6}, Lio/sentry/transport/w;-><init>(IILjava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;Lio/sentry/ILogger;Lio/sentry/i2;)V
...
.method private static synthetic o(Lio/sentry/cache/g;Lio/sentry/ILogger;Ljava/lang/Runnable;Ljava/util/concurrent/ThreadPoolExecutor;)V
    .locals 1
    ...
    .line 6
    .line 7
    invoke-static {p2}, Lio/sentry/transport/e$c;->h(Lio/sentry/transport/e$c;)Lio/sentry/I;
    ...
    .line 18
    .line 19
    invoke-static {p2}, Lio/sentry/transport/e$c;->i(Lio/sentry/transport/e$c;)Lio/sentry/j2;
    ...
    .line 27
    invoke-interface {p0, p3, v0}, Lio/sentry/cache/g;->l1(Lio/sentry/j2;Lio/sentry/I;)Z
    ...
    .line 35
    invoke-static {p0, p2}, Lio/sentry/transport/e;->y(Lio/sentry/I;Z)V

    .line 36
    .line 37
    .line 38
    sget-object p0, Lio/sentry/Y2;->WARNING:Lio/sentry/Y2;
    ...
    .line 44
    .line 45
    invoke-interface {p1, p0, p3, p2}, Lio/sentry/ILogger;->c(Lio/sentry/Y2;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static synthetic q(Lio/sentry/hints/p;)V
    .locals 1
...
.method private static synthetic r(ZLio/sentry/hints/k;)V
    .locals 0
...
.method private synthetic u(Lio/sentry/hints/g;)V
    .locals 3
    ...
    .line 3
    .line 4
    iget-object p1, p0, Lio/sentry/transport/e;->c:Lio/sentry/n3;
...
.method private static y(Lio/sentry/I;Z)V
    .locals 2
    ...
    .line 7
    .line 8
    invoke-static {p0, v1, v0}, Lio/sentry/util/m;->o(Lio/sentry/I;Ljava/lang/Class;Lio/sentry/util/m$a;)V
    ...
    .line 17
    .line 18
    invoke-static {p0, p1, v0}, Lio/sentry/util/m;->o(Lio/sentry/I;Ljava/lang/Class;Lio/sentry/util/m$a;)V
...
.method public Z(Lio/sentry/j2;Lio/sentry/I;)V
    ...
    .line 4
    .line 5
    invoke-static {p2, v1}, Lio/sentry/util/m;->h(Lio/sentry/I;Ljava/lang/Class;)Z
    ...
    .line 16
    iget-object v1, p0, Lio/sentry/transport/e;->c:Lio/sentry/n3;
    ...
    .line 33
    .line 34
    invoke-virtual {v1, p1, p2}, Lio/sentry/transport/A;->j(Lio/sentry/j2;Lio/sentry/I;)Lio/sentry/j2;
    ...
    .line 43
    .line 44
    invoke-interface {p2, p1}, Lio/sentry/cache/g;->H(Lio/sentry/j2;)V
    ...
    .line 49
    .line 50
    invoke-static {p2, p1}, Lio/sentry/util/m;->h(Lio/sentry/I;Ljava/lang/Class;)Z
    ...
    .line 62
    invoke-interface {p1, v1}, Lio/sentry/clientreport/h;->e(Lio/sentry/j2;)Lio/sentry/j2;
    ...
    .line 69
    .line 70
    invoke-direct {v2, p0, v1, p2, v0}, Lio/sentry/transport/e$c;-><init>(Lio/sentry/transport/e;Lio/sentry/j2;Lio/sentry/I;Lio/sentry/cache/g;)V
    ...
    .line 92
    .line 93
    invoke-interface {p1, p2, v1}, Lio/sentry/clientreport/h;->b(Lio/sentry/clientreport/f;Lio/sentry/j2;)V
    ...
    .line 103
    .line 104
    invoke-static {p2, v0, p1}, Lio/sentry/util/m;->o(Lio/sentry/I;Ljava/lang/Class;Lio/sentry/util/m$a;)V
...
.method public c(Z)V
    ...
    .line 2
    .line 3
    invoke-virtual {v0}, Lio/sentry/transport/A;->close()V
    ...
    .line 10
    .line 11
    iget-object v0, p0, Lio/sentry/transport/e;->c:Lio/sentry/n3;
    ...
    .line 30
    .line 31
    invoke-virtual {p1}, Lio/sentry/n3;->getFlushTimeoutMillis()J
    ...
    .line 76
    .line 77
    invoke-interface {p1, v3, v0, v1}, Lio/sentry/ILogger;->c(Lio/sentry/Y2;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public p()Z
    ...
    .line 2
    .line 3
    invoke-virtual {v0}, Lio/sentry/transport/A;->o()Z
