...
.method public constructor <init>(Lio/sentry/n3;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/sentry/android/ndk/d;-><init>(Lio/sentry/n3;Lio/sentry/ndk/a;)V

    return-void
.end method

.method constructor <init>(Lio/sentry/n3;Lio/sentry/ndk/a;)V
    .locals 1
    ...
    iput-object p1, p0, Lio/sentry/android/ndk/d;->a:Lio/sentry/n3;
    ...
    iput-object p1, p0, Lio/sentry/android/ndk/d;->b:Lio/sentry/ndk/a;

    return-void
.end method

.method public static synthetic f(Lio/sentry/android/ndk/d;Lio/sentry/e;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lio/sentry/android/ndk/d;->h(Lio/sentry/e;)V

    return-void
.end method

.method public static synthetic g(Lio/sentry/android/ndk/d;Lio/sentry/H3;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lio/sentry/android/ndk/d;->i(Lio/sentry/H3;)V

    return-void
.end method

.method private synthetic h(Lio/sentry/e;)V
    .locals 9

    .line 1
    invoke-virtual {p1}, Lio/sentry/e;->t()Lio/sentry/Y2;
    ...
    .line 42
    .line 43
    iget-object v2, p0, Lio/sentry/android/ndk/d;->a:Lio/sentry/n3;
    ...
    .line 49
    invoke-interface {v2, v0}, Lio/sentry/e0;->f(Ljava/util/Map;)Ljava/lang/String;
    ...
    .line 70
    .line 71
    invoke-interface {v2, v4, v0, v6, v5}, Lio/sentry/ILogger;->a(Lio/sentry/Y2;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 75
    :goto_3
    iget-object v2, p0, Lio/sentry/android/ndk/d;->b:Lio/sentry/ndk/a;

    .line 76
    .line 77
    invoke-virtual {p1}, Lio/sentry/e;->u()Ljava/lang/String;
...
.method private synthetic i(Lio/sentry/H3;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lio/sentry/android/ndk/d;->b:Lio/sentry/ndk/a;
    ...
    .line 19
    invoke-interface {v0, v1, p1}, Lio/sentry/ndk/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Lio/sentry/e;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/sentry/android/ndk/d;->a:Lio/sentry/n3;
    ...
    .line 8
    .line 9
    invoke-direct {v1, p0, p1}, Lio/sentry/android/ndk/b;-><init>(Lio/sentry/android/ndk/d;Lio/sentry/e;)V
...
.method public c(Lio/sentry/H3;Lio/sentry/X;)V
    ...
    :cond_0
    :try_start_0
    iget-object p2, p0, Lio/sentry/android/ndk/d;->a:Lio/sentry/n3;
    ...
    .line 11
    .line 12
    invoke-direct {v0, p0, p1}, Lio/sentry/android/ndk/c;-><init>(Lio/sentry/android/ndk/d;Lio/sentry/H3;)V
