...
.field private final b:Lio/sentry/android/core/internal/util/m;
...
.method public constructor <init>(Lio/sentry/android/core/SentryAndroidOptions;)V
    ...
    .line 23
    invoke-direct {v0, v1, v2, v3, v4}, Lio/sentry/android/core/internal/util/m;-><init>(Lio/sentry/transport/p;JI)V

    .line 24
    .line 25
    .line 26
    iput-object v0, p0, Lio/sentry/android/core/ViewHierarchyEventProcessor;->b:Lio/sentry/android/core/internal/util/m;
...
.method private static d(Landroid/view/View;Lio/sentry/protocol/I;Ljava/util/List;)V
    .locals 5
    ...
    .line 38
    .line 39
    invoke-static {v3}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->i(Landroid/view/View;)Lio/sentry/protocol/I;
    ...
    .line 45
    .line 46
    invoke-static {v3, v4, p2}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->d(Landroid/view/View;Lio/sentry/protocol/I;Ljava/util/List;)V
    ...
    .line 52
    :cond_3
    invoke-virtual {p1, v1}, Lio/sentry/protocol/I;->m(Ljava/util/List;)V
...
.method private static synthetic e(Ljava/util/concurrent/atomic/AtomicReference;Landroid/view/View;Ljava/util/List;Ljava/util/concurrent/CountDownLatch;Lio/sentry/ILogger;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p1, p2}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->h(Landroid/view/View;Ljava/util/List;)Lio/sentry/protocol/H;
...
.method public static g(Landroid/app/Activity;Ljava/util/List;Lio/sentry/util/thread/a;Lio/sentry/ILogger;)Lio/sentry/protocol/H;
    .locals 9
    ...
    .line 10
    .line 11
    invoke-interface {p3, p0, p1, p2}, Lio/sentry/ILogger;->c(Lio/sentry/Y2;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 52
    .line 53
    invoke-static {v4, p1}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->h(Landroid/view/View;Ljava/util/List;)Lio/sentry/protocol/H;
    ...
    .line 78
    invoke-direct/range {v2 .. v7}, Lio/sentry/android/core/a1;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Landroid/view/View;Ljava/util/List;Ljava/util/concurrent/CountDownLatch;Lio/sentry/ILogger;)V
    ...
    .line 104
    .line 105
    invoke-interface {p3, p1, p2, p0}, Lio/sentry/ILogger;->b(Lio/sentry/Y2;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static h(Landroid/view/View;Ljava/util/List;)Lio/sentry/protocol/H;
    .locals 3
    ...
    .line 10
    .line 11
    invoke-direct {v1, v2, v0}, Lio/sentry/protocol/H;-><init>(Ljava/lang/String;Ljava/util/List;)V

    .line 12
    .line 13
    .line 14
    invoke-static {p0}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->i(Landroid/view/View;)Lio/sentry/protocol/I;
    ...
    .line 20
    .line 21
    invoke-static {p0, v2, p1}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->d(Landroid/view/View;Lio/sentry/protocol/I;Ljava/util/List;)V
...
.method private static i(Landroid/view/View;)Lio/sentry/protocol/I;
    .locals 3
    ...
    .line 5
    .line 6
    invoke-static {p0}, Lio/sentry/android/core/internal/util/j;->a(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 29
    invoke-virtual {v0, v1}, Lio/sentry/protocol/I;->t(Ljava/lang/Double;)V
    ...
    .line 41
    invoke-virtual {v0, v1}, Lio/sentry/protocol/I;->u(Ljava/lang/Double;)V
    ...
    .line 53
    invoke-virtual {v0, v1}, Lio/sentry/protocol/I;->s(Ljava/lang/Double;)V
    ...
    .line 65
    invoke-virtual {v0, v1}, Lio/sentry/protocol/I;->n(Ljava/lang/Double;)V
    ...
    .line 77
    invoke-virtual {v0, v1}, Lio/sentry/protocol/I;->l(Ljava/lang/Double;)V
    ...
    .line 95
    .line 96
    invoke-virtual {v0, p0}, Lio/sentry/protocol/I;->r(Ljava/lang/String;)V
...
.method public b(Lio/sentry/L2;Lio/sentry/I;)Lio/sentry/L2;
    ...
    .line 40
    :cond_2
    iget-object v0, p0, Lio/sentry/android/core/ViewHierarchyEventProcessor;->b:Lio/sentry/android/core/internal/util/m;

    .line 41
    .line 42
    invoke-virtual {v0}, Lio/sentry/android/core/internal/util/m;->a()Z
    ...
    .line 63
    .line 64
    invoke-virtual {v1}, Lio/sentry/n3;->getViewHierarchyExporters()Ljava/util/List;
    ...
    .line 69
    .line 70
    invoke-virtual {v2}, Lio/sentry/n3;->getThreadChecker()Lio/sentry/util/thread/a;
    ...
    .line 80
    invoke-static {v0, v1, v2, v3}, Lio/sentry/android/core/ViewHierarchyEventProcessor;->g(Landroid/app/Activity;Ljava/util/List;Lio/sentry/util/thread/a;Lio/sentry/ILogger;)Lio/sentry/protocol/H;
    ...
    .line 85
    .line 86
    invoke-static {v0}, Lio/sentry/b;->c(Lio/sentry/protocol/H;)Lio/sentry/b;
    ...
    .line 90
    invoke-virtual {p2, v0}, Lio/sentry/I;->o(Lio/sentry/b;)V
