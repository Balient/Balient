...
.field public final i:Lio/appmetrica/analytics/impl/g3;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Lio/appmetrica/analytics/billinginterface/internal/BillingType;Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoStorage;Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoSender;)V
    ...
    invoke-virtual {v0}, Lio/appmetrica/analytics/impl/ha;->c()Lio/appmetrica/analytics/impl/h2;

    move-result-object v8

    new-instance v9, Lio/appmetrica/analytics/impl/g3;

    invoke-direct {v9}, Lio/appmetrica/analytics/impl/g3;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Lio/appmetrica/analytics/billinginterface/internal/BillingType;Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoStorage;Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoSender;Lio/appmetrica/analytics/coreapi/internal/servicecomponents/applicationstate/ApplicationStateProvider;Lio/appmetrica/analytics/impl/g3;)V
    ...
    .line 4
    iput-object p1, p0, Lio/appmetrica/analytics/impl/i3;->b:Landroid/content/Context;

    .line 5
    iput-object p2, p0, Lio/appmetrica/analytics/impl/i3;->c:Ljava/util/concurrent/Executor;

    .line 6
    iput-object p3, p0, Lio/appmetrica/analytics/impl/i3;->d:Ljava/util/concurrent/Executor;

    .line 7
    iput-object p4, p0, Lio/appmetrica/analytics/impl/i3;->e:Lio/appmetrica/analytics/billinginterface/internal/BillingType;

    .line 8
    iput-object p5, p0, Lio/appmetrica/analytics/impl/i3;->f:Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoStorage;

    .line 9
    iput-object p6, p0, Lio/appmetrica/analytics/impl/i3;->g:Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoSender;

    .line 10
    iput-object p7, p0, Lio/appmetrica/analytics/impl/i3;->h:Lio/appmetrica/analytics/coreapi/internal/servicecomponents/applicationstate/ApplicationStateProvider;

    .line 11
    iput-object p8, p0, Lio/appmetrica/analytics/impl/i3;->i:Lio/appmetrica/analytics/impl/g3;
...
# virtual methods
.method public final declared-synchronized a(Lio/appmetrica/analytics/impl/fl;)V
    .locals 1
    ...
    .line 19
    :try_start_1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/i3;->a:Lio/appmetrica/analytics/billinginterface/internal/monitor/BillingMonitor;
    ...
    .line 21
    :try_start_2
    iget-object p1, p1, Lio/appmetrica/analytics/impl/fl;->x:Lio/appmetrica/analytics/billinginterface/internal/config/BillingConfig;
...
.method public final a(Lio/appmetrica/analytics/impl/fl;Ljava/lang/Boolean;)V
    .locals 10
    ...
    .line 3
    :try_start_0
    iget-object p2, p0, Lio/appmetrica/analytics/impl/i3;->i:Lio/appmetrica/analytics/impl/g3;

    iget-object v1, p0, Lio/appmetrica/analytics/impl/i3;->b:Landroid/content/Context;

    iget-object v2, p0, Lio/appmetrica/analytics/impl/i3;->c:Ljava/util/concurrent/Executor;

    iget-object v3, p0, Lio/appmetrica/analytics/impl/i3;->d:Ljava/util/concurrent/Executor;

    iget-object v0, p0, Lio/appmetrica/analytics/impl/i3;->e:Lio/appmetrica/analytics/billinginterface/internal/BillingType;

    iget-object v4, p0, Lio/appmetrica/analytics/impl/i3;->f:Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoStorage;

    iget-object v5, p0, Lio/appmetrica/analytics/impl/i3;->g:Lio/appmetrica/analytics/billinginterface/internal/storage/BillingInfoSender;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 4
    sget-object p2, Lio/appmetrica/analytics/impl/f3;->a:[I
    ...
    invoke-direct {p2}, Lio/appmetrica/analytics/impl/P7;-><init>()V

    .line 7
    :goto_0
    iput-object p2, p0, Lio/appmetrica/analytics/impl/i3;->a:Lio/appmetrica/analytics/billinginterface/internal/monitor/BillingMonitor;
    ...
    .line 11
    new-instance p1, Lio/appmetrica/analytics/impl/h3;

    invoke-direct {p1, p0}, Lio/appmetrica/analytics/impl/h3;-><init>(Lio/appmetrica/analytics/impl/i3;)V

    .line 12
    iget-object p2, p0, Lio/appmetrica/analytics/impl/i3;->h:Lio/appmetrica/analytics/coreapi/internal/servicecomponents/applicationstate/ApplicationStateProvider;
    ...
    .line 15
    :try_start_1
    iget-object p1, p0, Lio/appmetrica/analytics/impl/i3;->a:Lio/appmetrica/analytics/billinginterface/internal/monitor/BillingMonitor;
