...
.method a(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    .line 12
    .line 13
    invoke-interface {p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->n()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 60
    .line 61
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->u()V
    ...
    .line 68
    .line 69
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->x()V
...
.method h0(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    .locals 3
...
.method public r(Landroid/content/Intent;)Z
    ...
    .line 45
    :cond_2
    invoke-interface {v1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->m()Lir/nasim/kh4;
    ...
    .line 80
    .line 81
    invoke-interface {v1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->n()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 101
    .line 102
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->c0()V
